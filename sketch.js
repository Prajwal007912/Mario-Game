...
function preload(){
  ...
  groundImage = loadImage("mariowall.png");
  ...
  gameSound = loadSound("super-mario-bros-4293.mp3");
  wallpaper = loadImage("mariowall.png"); 
}
